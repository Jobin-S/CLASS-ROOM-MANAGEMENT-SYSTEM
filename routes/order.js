...
const { generateRazorPay, createOrder, verifyPayment, confirmPurchase, paypalPay, verifyPaypal, paypalConfirmPurchase } = require('../helpers/order-helpers');
...
router.post('/paypal', (req, res)=>{
  ...
  createOrder(req.session.student._id, req.body['event[eventId]'], 'paypal').then((orderId)=>{
